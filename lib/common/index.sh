...
KC_ASDF_NAME="asdf-golangci-lint"
KC_ASDF_REPO="https://github.com/kc-workspace/asdf-golangci-lint"
export KC_ASDF_ORG KC_ASDF_NAME KC_ASDF_REPO

## Application information
KC_ASDF_APP_TYPE="standalone"
KC_ASDF_APP_NAME="golangci-lint"
KC_ASDF_APP_WEBS="https://golangci-lint.run/"
KC_ASDF_APP_DESC="Fast linters Runner for Go"
KC_ASDF_APP_REPO="https://github.com/golangci/golangci-lint"
